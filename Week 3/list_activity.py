...
print(holiday_items)
# don't need to input anything within the brackets. The menthod .reverse will automatically reverse the order of the list
...
print(holiday_items)
# You need to create a variable for the Extra Items (Extra_Items). I've assigned Clothes and Book to this variable. On line 128, code tells the holiday_item variable to extend the list witht he extra_item variable.
